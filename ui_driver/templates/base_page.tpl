...
import logging
import os
from ui_driver.logger_handler import LoggerHandler
import allure
import yaml
...
from ui_driver.handle_exception import handle_exception
...
class BasePage:
    ...
    def __init__(self, driver: WebDriver = None):
        self.logger = LoggerHandler.get_logger('test', 'app_demo.log')
        from ui_driver.app import App
        from ui_driver.web import Web
        if driver is None:
